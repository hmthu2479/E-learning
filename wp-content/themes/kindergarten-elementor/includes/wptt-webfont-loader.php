...
if ( ! class_exists( 'Kindergarten_Elementor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Kindergarten_Elementor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Kindergarten_Elementor_WPTT_WebFont_Loader( $url );
